...
if ( ! class_exists( 'Edumall_Tutor' ) ) {
	class Edumall_Tutor {
		 ...
		 * @var string
		 */
		const MINIMUM_TUTOR_VERSION = '1.9.1';
		 ...
		 * @var string
		 */
		const MINIMUM_TUTOR_PRO_VERSION = '1.9.1';
		...
		public function get_total_students_by_instructor( $instructor_id ) {
			...
			$my_courses = $this->get_courses_ids_by_instructor( $instructor_id );
		 ...
		 * @since 2.7.4
		 */
		public function get_courses_ids_by_instructor( $instructor_id = 0, $post_status = array( 'publish' ) ) {
			global $wpdb;
