...
class Widget_Contact_Form_7 extends Form_Base {
	...
	public function get_title() {
		return esc_html__( 'Contact Form 7', 'edumall' );
	}
	...
	private function get_form_list() {
		...
		if ( $cf7 ) {
			...
			$forms[0] = esc_html__( 'No contact forms found', 'edumall' );
		}
	...
	private function add_content_section() {
		...
		$this->add_control( 'form_id', [
			'label'   => esc_html__( 'Select Form', 'edumall' ),
	...
	private function add_form_style_section() {
		...
		$this->add_control(
			'column_gap',
			[
				'label'     => esc_html__( 'Columns Gap', 'edumall' ),
		...
		$this->add_control(
			'row_gap',
			[
				'label'     => esc_html__( 'Rows Gap', 'edumall' ),
				'type'      => Controls_Manager::SLIDER,
				'default'   => [
					'size' => 20,
				],
