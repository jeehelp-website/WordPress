...
class Widget_Init {
	...
	public function init_widgets( $widget_manager ) {
		...
		// Register Widgets.
		$widget_manager->register_widget_type( new Widget_Accordion() );
		$widget_manager->register_widget_type( new Widget_Tabs() );
		$widget_manager->register_widget_type( new Widget_Button() );
		$widget_manager->register_widget_type( new Widget_Client_Logo() );
		$widget_manager->register_widget_type( new Widget_Circle_Progress_Chart() );
		$widget_manager->register_widget_type( new Widget_Counter() );
		$widget_manager->register_widget_type( new Widget_Countdown() );
		$widget_manager->register_widget_type( new Widget_Google_Map() );
		$widget_manager->register_widget_type( new Widget_Heading() );
		$widget_manager->register_widget_type( new Widget_Typed_Headline() );
		$widget_manager->register_widget_type( new Widget_Icon() );
		$widget_manager->register_widget_type( new Widget_Icon_Box() );
		$widget_manager->register_widget_type( new Widget_Image_Box() );
		$widget_manager->register_widget_type( new Widget_Image_Layers() );
		$widget_manager->register_widget_type( new Widget_Image_Gallery() );
		$widget_manager->register_widget_type( new Widget_Carousel_Nav_Buttons() );
		$widget_manager->register_widget_type( new Widget_Image_Carousel() );
		$widget_manager->register_widget_type( new Widget_Rich_Carousel() );
		$widget_manager->register_widget_type( new Widget_Gallery_Justified_Content() );
		$widget_manager->register_widget_type( new Widget_Banner() );
		$widget_manager->register_widget_type( new Widget_Shapes() );
		$widget_manager->register_widget_type( new Widget_Modern_Carousel() );
		$widget_manager->register_widget_type( new Widget_Modern_Slider() );
		$widget_manager->register_widget_type( new Widget_Flip_Box() );
		$widget_manager->register_widget_type( new Widget_Blog() );
		$widget_manager->register_widget_type( new Widget_FAQ_Cards() );
		$widget_manager->register_widget_type( new Widget_Register_Form() );
		$widget_manager->register_widget_type( new Widget_Portfolio() );
		$widget_manager->register_widget_type( new Widget_Portfolio_Carousel() );
		$widget_manager->register_widget_type( new Widget_Portfolio_Details() );
		$widget_manager->register_widget_type( new Widget_Attribute_List() );
		$widget_manager->register_widget_type( new Widget_List() );
		$widget_manager->register_widget_type( new Widget_Gradation() );
		$widget_manager->register_widget_type( new Widget_Timeline() );
		$widget_manager->register_widget_type( new Widget_Pricing_Table() );
		$widget_manager->register_widget_type( new Widget_Twitter() );
		$widget_manager->register_widget_type( new Widget_Team_Member() );
		$widget_manager->register_widget_type( new Widget_Team_Member_Carousel() );
		$widget_manager->register_widget_type( new Widget_Testimonial_Carousel() );
		$widget_manager->register_widget_type( new Widget_Testimonial_Carousel_3D() );
		$widget_manager->register_widget_type( new Widget_Testimonial_Grid() );
		$widget_manager->register_widget_type( new Widget_Social_Networks() );
		$widget_manager->register_widget_type( new Widget_Star_Rating() );
		$widget_manager->register_widget_type( new Widget_Popup_Video() );
		$widget_manager->register_widget_type( new Widget_Separator() );
		$widget_manager->register_widget_type( new Widget_Table() );
		$widget_manager->register_widget_type( new Widget_Full_Page() );
		$widget_manager->register_widget_type( new Widget_View_Demo() );
		...
		if ( \Edumall_Woo::instance()->is_activated() ) {
			...
			$widget_manager->register_widget_type( new Widget_Product() );
			$widget_manager->register_widget_type( new Widget_Product_Categories() );
		}
		...
		if ( \Edumall_Tutor::instance()->is_activated() ) {
			...
			$widget_manager->register_widget_type( new Widget_Course() );
			$widget_manager->register_widget_type( new Widget_Course_Tabs() );
			$widget_manager->register_widget_type( new Widget_Course_Carousel() );
			$widget_manager->register_widget_type( new Widget_Course_Category_Carousel() );
			$widget_manager->register_widget_type( new Widget_Course_Category_Cards() );
			$widget_manager->register_widget_type( new Widget_Course_Search_Form() );

			if ( class_exists( 'Edumall_Addons' ) ) {
				require_once EDUMALL_ELEMENTOR_DIR . '/widgets/terms/course-languages.php';

				$widget_manager->register_widget_type( new Widget_Course_Languages() );
			}
		}
		...
		if ( \Edumall_Event::instance()->is_activated() ) {
			...
			$widget_manager->register_widget_type( new Widget_Event() );
			$widget_manager->register_widget_type( new Widget_Event_Carousel() );
		}

		if ( \Edumall_Zoom_Meeting::instance()->is_activated() ) {
			require_once EDUMALL_ELEMENTOR_DIR . '/widgets/zoom-meeting.php';

			$widget_manager->register_widget_type( new Widget_Zoom_Meeting() );
		}

		if ( defined( 'WPCF7_VERSION' ) ) {
			require_once EDUMALL_ELEMENTOR_DIR . '/widgets/form/contact-form-7.php';

			$widget_manager->register_widget_type( new Widget_Contact_Form_7() );
		}

		if ( function_exists( 'mc4wp_get_forms' ) ) {
			require_once EDUMALL_ELEMENTOR_DIR . '/widgets/form/mailchimp-form.php';

			$widget_manager->register_widget_type( new Widget_Mailchimp_Form() );
		}
	}
