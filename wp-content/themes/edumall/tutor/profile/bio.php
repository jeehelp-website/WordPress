...
$bio          = nl2br( get_user_meta( $profile_user_id, '_tutor_profile_bio', true ) );
$job_title    = get_user_meta( $profile_user_id, '_tutor_profile_job_title', true );
...
<div class="tutor-dashboard-content-inner">
	<div class="dashboard-profile-info">
		<div class="dashboard-profile-info-item profile-display-name">
			...
			<div class="content">
				<p><?php echo esc_html( sprintf( '%s', $display_name ? $display_name : $placeholder ) ); ?></p>
			</div>
		</div>
		<?php if ( ! empty( $phone ) ) : ?>
